...
public class BankTest {
    ...
    @Test
    public void createBanksAddClientsCreateAddAccounts() {
        List<Integer> boundarySums1 = new ArrayList<>(Arrays.asList(0, 50000, 100000, 150000, 200000));
        List<Integer> boundarySums2 = new ArrayList<>(Arrays.asList(0, 100000, 200000, 300000));

        List<Integer> percents1 = new ArrayList<>(Arrays.asList(4, 6, 8, 10));
        List<Integer> percents2 = new ArrayList<>(Arrays.asList(4, 8, 12));
